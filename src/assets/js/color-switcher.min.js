(function (d) {
  ...
  d.cColorSwitcher = function (b) {
    ...
    var a = d('<div id="cColorSwitcher"></div>'),
      e = d("head"),
      f = d("body");
    a.css({ transform: "translateY(-50%)" }).addClass("clearfix");
    d('<div class="ccs--body"><h6>' + b.switcherTitle + "</h6><ul></ul></div>")
      .appendTo(a)
      .children("ul")
      .append(function () {
        var a = "",
        ...
        for (c = 0; c < b.switcherColors.length; c++)
          "undefined" === typeof b.switcherColors[c].fgColor &&
            ...
            (a =
              ...
              ';"></span><span style="transform: rotate(45deg); background-color: ' +
    ...
    var g = d(
      ...
      .on("click", function () {
        a.hasClass("opened")
          ? (a.removeClass("opened"),
            "right" === b.position
              ? a.animate({ right: "-220px" }, 500)
              : a.animate({ left: "-220px" }, 500))
          : (a.addClass("opened"),
            "right" === b.position
      ...
      .appendTo(a);
    "right" === b.position && a.css({ left: "auto", right: "-220px" });
    e.append(
